...
<body id="agrupar">
       ...
       $conexion=mysql_connect("localhost","root","gday") or die("Problemas en la conexion");
        ...
        $registros=mysql_query("select CURP,Nombre
        from Alumnos where Nombre LIKE '$_REQUEST[Nombre]%'",$conexion) or die("Problemas en el select:".mysql_error());
        $contador=mysql_num_rows($registros);
       if($contador==0){
             ?>
             <p>Ningun Registro fue encontrado con ese nombre</p>
        ...
        ?>
         ...
         <div>
                <h1>REGISTROS ENCONTRADOS</h1>
                         ...
                         <table width="270" border="0" cellspacing="6" cellpadding="0" class="mitabla">
        ...
        while($reg=mysql_fetch_assoc($registros)){
           ...
           ?>
                         ...
                         <tr>
                         <td width="266"><?php echo $reg['Nombre'];?></td><td><?php echo $reg['CURP'];?></td>
                         </tr>
