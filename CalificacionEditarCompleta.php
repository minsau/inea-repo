...
<body id="agrupar">
        ...
        if ($reg=mysql_fetch_array($registros)){
            ?>
              ...
              <section id="seccion">
                <article>
                        <header>
                        Actualizar informacion sobre el alumno
                        </header>
        ...
        ?>
                                                         ...
                                                         <form action="CalificacionEditarCompletaFull.php" method="get" class ="contact_form">
                                                                 <ul>     <input type="hidden" name="CURP" value="<?php echo $id_a; ?>">
                                                                          ...
                                                                          <li><label for="name">Calificacion</label><input type="text" name="calificacion"value="<?php echo $calificacion; ?>"></li>
       ...
       <form action="DatosEliminarCompletos.php" method="get" class ="contact_form" >
                ...
                <h1>No Encontramos Esa Curp Intenta nuevamente</h1>
