...
<body id="agrupar">
        ...
        $registros=mysql_query("select loggin,pass from Administrador where loggin='$_REQUEST[loggin]' and pass='$_REQUEST[pass]'",$conexion) or die("Problemas en el select:".mysql_error());
      ...
      <div>
       <form  action="BuscadorAlumnos.php" method="get" class ="contact_form" >
        ...
        <form  action="RevisarAdministrador.php" method="get" class ="contact_form" >
                <ul>
                        <li><label for="name">Error intentalo otra vez</label></li><br>
