...
<body id="agrupar">
       ...
       $pass=$_GET['variable2'];
        ...
        $conexion=mysql_connect("localhost","root","gday") or die("Problemas en la conexion");
        mysql_select_db("escuela",$conexion) or die("Problemas en la seleccion de la base de datos");
       mysql_query("delete from Usuarios where loggin='$_REQUEST[CURP]'",$conexion) or
        die("Problemas en el select:".mysql_error());
       
       mysql_query("delete from Direccion where CURP_D='$_REQUEST[CURP]'",$conexion) or
        die("Problemas en el select:".mysql_error()); 
        
        mysql_query("delete from Telefonos where CURP_TEL='$_REQUEST[CURP]'",$conexion) or
        die("Problemas en el select:".mysql_error());
        
        mysql_query("delete from Toma where CURP_T='$_REQUEST[CURP]'",$conexion) or
        die("Problemas en el select:".mysql_error());
        mysql_query("delete from Historial where CURP_H='$_REQUEST[CURP]'",$conexion) or
        die("Problemas en el select:".mysql_error());
        
        mysql_query("delete from Alumnos where CURP='$_REQUEST[CURP]'",$conexion) or
        die("Problemas en el select:".mysql_error());
        ...
        ?>
                                                         ...
                                                         <h1>ELIMINADO</h1>
                                                                 ...
                                                                 <ul>
                                                                          <li><label for="name">ALUMNO ELIMINADO!</label></li>
